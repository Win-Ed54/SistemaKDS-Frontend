...
const OrderBuilder = ({
  ...
  const effectiveTableId = Number(sourceTableId) > 0 ? Number(sourceTableId) : Number(tableId);
  const hasSelectedLocation = effectiveTableId !== null && effectiveTableId !== undefined && effectiveTableId !== "";
  ...
  const sendOrder = async () => {
    ...
    const order = {
      tableNumber: Number.parseInt(String(effectiveTableId), 10),
