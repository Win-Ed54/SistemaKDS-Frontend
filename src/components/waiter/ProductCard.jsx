...
const ProductCard = ({ product, onAdd, onOpenNotes }) => {
  ...
  return (
    <div className={`group rounded-[2.5rem] border-2 overflow-hidden transition-all duration-300 flex flex-col h-full relative ${
      ...
      <div className="relative w-full aspect-video bg-slate-800 overflow-hidden">
        ...
        <div className="absolute top-4 right-4 z-20">
          <span className={`text-[10px] px-4 py-1.5 rounded-2xl font-black backdrop-blur-md border ${
      ...
      <div className="p-6 flex flex-col flex-1">
        <div className="mb-4">
          <h3 className="font-black text-xl text-white mb-1 uppercase tracking-tight leading-tight">{product.name}</h3>
        ...
        <div className="mt-auto pt-5 border-t border-slate-800/50">
          <div className="mb-5 flex justify-between items-end">
             ...
             <span className="text-[#39FF14] font-black text-3xl tracking-tighter">
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className={`w-full py-5 rounded-[1.2rem] font-black text-[11px] uppercase tracking-[0.2em] transition-all ${
            ...
            <button
              ...
              disabled={isOutOfStock}
              className={`w-full py-4 rounded-[1.2rem] border-2 text-[10px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${
                cartItem?.notes 
